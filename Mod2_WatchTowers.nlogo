...
to setup
  ...
  set trees-per-tower int ( total-trees / total-number-of-towers )
  ...
  ask patches [
    ...
    [
      ...
      (ifelse
        trees-counter mod trees-per-tower = 0
        [set pcolor white]
        [set pcolor green ])
  ]
  ]
...
to go
  ...
  ask patches with [ pcolor = white ] [
    if count patches in-radius visibility with [ pcolor = red ] > 0
    [ set pcolor green
